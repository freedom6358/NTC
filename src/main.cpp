...
const string strMessageMagic = "NTC Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NTC", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "February, 2016: Network Transaction Coin Launches";
        CTransaction txNew;
        txNew.nTime = 1455869903;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1455869903;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1652806;
        ...
        assert(block.hashMerkleRoot == uint256("0x2010efe9cf0c519dffc7d1b7354c63b0f4cffe3569331f61fc0b27d528d5d8a5"));
